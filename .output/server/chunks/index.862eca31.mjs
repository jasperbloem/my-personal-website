...
import { withCtx, unref, createVNode, useSSRContext, mergeProps, resolveDynamicComponent, openBlock, createElementBlock, createElementVNode } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrRenderVNode, ssrInterpolate } from 'vue/server-renderer';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "stack-container" }, _attrs))}><div class="stacks"><h2>My favorite stack</h2><div class="stack-items"><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="stacks"><h2>Other skills</h2><div class="stack-items"><!--[-->`);
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="home-heading"><h1>Jasper Bloem, <span>full-stack developer</span></h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span${_scopeId}>Contact me</span>`);
          } else {
            return [
              createVNode(unref(MailIcon)),
              createVNode("span", null, "Contact me")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index.862eca31.mjs.map
