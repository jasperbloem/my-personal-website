...
import { unref, withCtx, createVNode, toDisplayString, useSSRContext, mergeProps, resolveDynamicComponent, openBlock, createElementBlock, createElementVNode } from 'vue';
...
const VueIcon = { name: "vscode-icons-file-type-vue", render: render$8 };
const _hoisted_1$7 = {
  viewBox: "0 0 256 172",
  width: "1.2em",
  height: "1.2em"
...
const NuxtIcon = { name: "logos-nuxt-icon", render: render$7 };
const _hoisted_1$6 = {
  viewBox: "0 0 256 192",
  width: "1.2em",
  height: "1.2em"
...
const SassIcon = { name: "logos-sass", render: render$6 };
const _hoisted_1$5 = {
  viewBox: "0 0 256 228",
  width: "1.2em",
  height: "1.2em"
...
const ReactIcon = { name: "logos-react", render: render$5 };
const _hoisted_1$4 = {
  viewBox: "0 0 256 250",
  width: "1.2em",
  height: "1.2em"
...
const PhotoshopIcon = { name: "logos-adobe-photoshop", render: render$4 };
const _hoisted_1$3 = {
  viewBox: "0 0 256 250",
  width: "1.2em",
  height: "1.2em"
};
const _hoisted_2$3 = /* @__PURE__ */ createElementVNode("rect", {
  width: "256",
  height: "249.6",
  fill: "#300",
  rx: "42.5"
...
const IllustratorIcon = { name: "logos-adobe-illustrator", render: render$3 };
const _hoisted_1$2 = {
  viewBox: "0 0 256 256",
  width: "1.2em",
  height: "1.2em"
...
const GitIcon = { name: "logos-git-icon", render: render$2 };
const _hoisted_1$1 = {
  viewBox: "0 0 256 264",
  width: "1.2em",
  height: "1.2em"
...
const LaravelIcon = { name: "logos-laravel", render: render$1 };
const _hoisted_1 = {
  viewBox: "0 0 256 257",
  width: "1.2em",
  height: "1.2em"
...
const SymfonyIcon = { name: "logos-symfony", render };
const _sfc_main$1 = {
  __name: "SkillStackContainer",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "stack-container" }, _attrs))}><div class="stacks"><h2>${ssrInterpolate(_ctx.$t("My favorite stack"))}</h2><div class="stack-items"><!--[-->`);
      ssrRenderList(favoriteStack, (item) => {
        _push(`<div class="stack-item">`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(item.icon), null, null), _parent);
        _push(`<span>${ssrInterpolate(item.title)}</span></div>`);
      });
      _push(`<!--]--></div></div><div class="stacks"><h2>${ssrInterpolate(_ctx.$t("Other skills"))}</h2><div class="stack-items"><!--[-->`);
      ssrRenderList(otherSkills, (item) => {
        _push(`<div class="stack-item">`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(item.icon), null, null), _parent);
        _push(`<span>${ssrInterpolate(item.title)}</span></div>`);
      });
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SkillStackContainer.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Home | Jasper Bloem - Full-stack developer",
      meta: [
        {
          name: "description",
          content: "Experienced full-stack web developer with skills in Vue.js, Nuxt.js, Laravel, Sass, React, Adobe Photoshop, Adobe Illustrator, Git, and Symfony. Available for new freelance jobs."
        },
        {
          name: "keywords",
          content: "full-stack web developer, freelance, Vue.js, Nuxt.js, Laravel, Sass, React, Adobe Photoshop, Adobe Illustrator, Git, Symfony"
        },
        {
          name: "author",
          content: "Jasper Bloem"
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$1;
      const _component_SkillStackContainer = _sfc_main$1;
      _push(`<!--[--><div class="home-heading"><h1>Jasper Bloem</h1><h2>full-stack developer</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath)("contact"),
        class: "home-contact-cta-btn"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(MailIcon), null, null, _parent2, _scopeId));
            _push2(`<span${_scopeId}>${ssrInterpolate(_ctx.$t("Contact me"))}</span>`);
          } else {
            return [
              createVNode(unref(MailIcon)),
              createVNode("span", null, toDisplayString(_ctx.$t("Contact me")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_SkillStackContainer, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
//# sourceMappingURL=index.6ef85304.mjs.map
