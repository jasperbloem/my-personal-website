...
<template>
    <div class="about-container">
        <div class="info-container">
            <h2>{{ $t('Meet') }}</h2>
            <h1>Jasper Bloem</h1>
            <div>{{ t('description', {}, { scope: 'local' }) }}</div>
        </div>
        <div class="image-container">
            <img src="/img/pf-siena-2023.png" alt="Jasper Bloem"/>
        </div>
    </div>
    <div class="portfolio-container mt-12">
        <h2>Portfolio</h2>
